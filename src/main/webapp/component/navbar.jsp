...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.jsp"><i class="fa-solid fa-house-medical-flag"></i>MEDI HOME</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item">
        ...
        <div class="dropdown">
  <button class="btn btn-sucess dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
